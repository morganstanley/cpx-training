...
_Please note that this step is not required if the bootloader is 0.4.0 or more recent! (see above)_
...
Let's download the list of required libraries from [here](https://github.com/morganstanley/makerspace/blob/main/code/Level%202%20-%20Intro%20to%20Programming/circup_libs_robotics.txt).
