...
_Veuillez noter que cette étape n'est pas nécessaire si le bootloader est en version 0.4.0 ou plus récente ! (voir ci-dessus)_
...
Téléchargeons la liste des bibliothèques requises depuis [ici](https://github.com/morganstanley/makerspace/blob/main/code/Level%202%20-%20Intro%20to%20Programming/circup_libs_robotics.txt).
