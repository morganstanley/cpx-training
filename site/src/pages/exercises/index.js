        ...
        <Layout location={location} title={siteTitle}>
            <div className="curriculum-main">
                ...
                <article className="content">
                    ...
                    <div>
                        <h3><Link to={`/exercises/circuitpython/level-1/`}>Introduction to CircuitPython - Level 1</Link></h3>
                        ...
                        <h3><Link to={`/exercises/circuitpython/level-2/`}>Programming with CircuitPython - Level 2</Link></h3>
                ...
                <article className="content">
                    ...
                    <div>
                        <h3><Link to={`/exercises/makecode/`}>MakeCode with the Circuit Playground Express</Link></h3>
                        <h4>Grades 5-7</h4>
                        ...
                        <h3><Link to={`/exercises/circuitpython/`}>CircuitPython with the Circuit Playground Express</Link></h3>
                        <h4>Grades 6-9</h4>
