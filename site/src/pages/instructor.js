        ...
        <Layout location={location} title={siteTitle}>
            <div className="trainer-main">
                ...
                <article className="content">
                    ...
                    <ul>
                        <li>Give students time and space to explore what catches their interest in each exercise.</li>
                        <li>Feel free to make mistakes in front of them and say that you don't know something. Let them know you are learning too.</li>
                        <li>When you don't know something, work through it out loud with the group. The troubleshooting process is a valuable skill to learn even if they don't take to coding.</li>
                        <li>If your group shows an interest in a certain aspect of a lession (color theory, music notes, etc), dive into it! This is what we are hoping for! Don't stress about the number of lessons. This moment is the most valuable learning moment.</li>
                        <li>If the lessons seem easy to your group, add challenges and encourage creativity.</li>
                    </ul>
                    <h3>Remote Lessons</h3>
                    <ul>
                        <li>Give students quiet time to work through the code. Check in by name in a rotating fashion.</li>
                        <li>Share your screen and demonstrate examples with your webcam if possible.</li>
                        <li>Encourage students to keep their camera on and mics unmuted to foster troubleshooting when needed and natural conversation.</li>
